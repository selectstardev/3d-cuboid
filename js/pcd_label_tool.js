    ...
    if (guiBoundingBoxMenuInitialized === false) {
        ...
        guiOptions.add(parameters, 'views', ['perspective', 'orthographic']).name("Select View").onChange(function (value) {
            ...
            if (value === labelTool.views.orthographic) {
                ...
                disablePointSizeSlider();
                pointCloudScanMap[labelTool.currentFileIndex].material.size = 1;
                setOrthographicView();
            } else {
        ...
        pointSizeSlider = guiOptions.add(parameters, 'point_size').name("Point Size").min(0.001).max(pointSizeMax).step(0.005).onChange(function (value) {
